...
execute as @e[tag=frying_pan] at @s run function culinary_craft:frying_pan/frying_pan

# execute as @e[tag=new_block] at @s run function culinary_craft:new_block
